...
{
   public class tbCompaniaAviacionTemporal
    {
        ...
        public string DireccionBilling { get; set; }
        public string TelefonoBilling { get; set; }
        public string CelularBilling { get; set; }
        public string EmailBilling { get; set; }
        public string Cargo { get; set; }
        public string RepresentanteLegalBilling { get; set; }
        public string NumeroCertificado { get; set; }
        public string FechaVigencia { get; set; }
        public string OidP5 { get; set; }
        public string EstadoTramite { get; set; }
        public string DescripcionEstadoTramite { get; set; }
        public string ObservacionTramite { get; set; }
        public bool TieneArchivo { get; set; }
        public Int32 OidPais { get; set; }
    }
}
