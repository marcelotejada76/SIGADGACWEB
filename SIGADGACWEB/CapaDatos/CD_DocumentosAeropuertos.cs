...
namespace CapaDatos
{
    public class CD_DocumentosAeropuertos
    {
        public static CD_DocumentosAeropuertos _instancia = null;
        private CD_DocumentosAeropuertos()
        {

        }

        public static CD_DocumentosAeropuertos Instancia
        {
            get
            {
                if (_instancia == null)
                {
                    _instancia = new CD_DocumentosAeropuertos();
                }
                return _instancia;
            }
        }
