...
namespace CapaDatos
{
    public class CD_DocumentosIfpds
    {
        public static CD_DocumentosIfpds _instancia = null;
        private CD_DocumentosIfpds()
        {

        }
        //EJEMPLO
        public static CD_DocumentosIfpds Instancia
        {
            get
            {
                if (_instancia == null)
                {
                    _instancia = new CD_DocumentosIfpds();
                }
                return _instancia;
            }
        }
        ...
        public List<tbDocumentosDsna> ConsultaDocumentosIfpds()
        {
            ...
            try
            {
                sbSol.Append("SELECT * FROM OPNAR1 WHERE OPNCO2=6 ");
