...
namespace CapaDatos
{
    public class CD_DocumentosIfpdsExpedientes
    {
        public static CD_DocumentosIfpdsExpedientes _instancia = null;
        private CD_DocumentosIfpdsExpedientes()
        {

        }

        public static CD_DocumentosIfpdsExpedientes Instancia
        {
            get
            {
                if (_instancia == null)
                {
                    _instancia = new CD_DocumentosIfpdsExpedientes();
                }
                return _instancia;
            }
        }
