...
namespace CapaDatos
{
    public class CD_DocumentosSeguridadOperacional
    {
        public static CD_DocumentosSeguridadOperacional _instancia = null;
        private CD_DocumentosSeguridadOperacional()
        {

        }

        public static CD_DocumentosSeguridadOperacional Instancia
        {
            get
            {
                if (_instancia == null)
                {
                    _instancia = new CD_DocumentosSeguridadOperacional();
                }
                return _instancia;
            }
        }
        ...
        public List<tbDocumentosGestionInterna> ConsultaDocumentosSeguridadOperacional()
        {
            ...
            try
            {
                sbSol.Append("SELECT * FROM OPNAR1 WHERE OPNCO2=3 ");
