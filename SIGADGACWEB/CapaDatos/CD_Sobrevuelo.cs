...
namespace CapaDatos
{
    public class CD_Sobrevuelo
    {
        ...
        //por matricula
        public List<tbSobrevuelo> ListadoSobrevuelosMatricula(string Matricula)
        {
            List<tbSobrevuelo> listarSolicitud = new List<tbSobrevuelo>();
            StringBuilder sbSol = new StringBuilder();
            string query = string.Empty;
        ...
        public List<tbSobrevuelo> ListadoSobrevuelosMatriculaFecha( string Matricula, string Fecha)
        {
            List<tbSobrevuelo> listarSolicitud = new List<tbSobrevuelo>();
            StringBuilder sbSol = new StringBuilder();
            string query = string.Empty;
