...
{
    public class ControlDocumentosCnsController : Controller
    {
        /// <summary>
        /// cambio por github
        /// </summary>
        ...
        public ActionResult ListadoDocumentosCns()
        {
            if (Session["Usuario"] == null)
                return RedirectToAction("login", "Login");
            ...
            listado = CD_ControlOperacionalCns.Instancia.DetalleDocumentos();
            return View(listado);
        }
        ...
        [HttpPost]
        public ActionResult ListadoDocumentosCns(DateTime FechaElab)
        {
            ...
            if (Fecha != "")
            {
                ...
                //Compania.ToUpper();
                listado = CD_ControlOperacionalCns.Instancia.DetalleDocumentosFecha(Fecha);
                //if (listado.Count==0)
                //{
        ...
        public ActionResult DescargaCheckList(string Fechaelab, string Turno)
        {
        ...
        //    Directory.CreateDirectory(miDirectorio);
            ...
            string remoteUri = @"\\172.20.19.55\DocumentosCns\CheckList_" + Fechaelab.Trim() + "_"+Turno.Trim()+".pdf";
            string fileName = "CheckList_" + Fechaelab.Trim() + "_" + Turno.Trim() + ".pdf";
