...
namespace SistemaIntegradoGestion.Controllers
{
    public class DocumentosAeropuertosInternacionalesController : Controller
    {
        ...
        public ActionResult ListadoDocumentosAeropuertosInternacionales()
        {
            ...
            listado = CD_DocumentosAeropuertos.Instancia.ConsultaDocumentosAeropuertos();// SolicitudModificacionReprogramacionSoloPOA(cAnio, SesionUsuario.CodigoSubsistema, "MDP");
            return View(listado);
        }
