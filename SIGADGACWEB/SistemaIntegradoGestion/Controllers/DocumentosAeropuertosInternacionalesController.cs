...
{
    public class DocumentosAeropuertosInternacionalesController : Controller
    {
        /// <summary>
        /// cambio por github
        /// </summary>
        ...
        public ActionResult ListadoDocumentosAeropuertosInternacionales()
        {
            if (Session["Usuario"] == null)
                return RedirectToAction("login", "Login");
            ...
            listado = CD_DocumentosAeropuertos.Instancia.ConsultaDocumentosAeropuertos(SesionUsuario.CodigoCiudad);// SolicitudModificacionReprogramacionSoloPOA(cAnio, SesionUsuario.CodigoSubsistema, "MDP");
            return View(listado);
        }
        ...
        public ActionResult DescargaDcto( string Nombre, string Grupo, string Nivel, string Subnivel)
        {
            ...
            string remoteUri = @"\\172.20.19.55\DocumentosDescarga\AEROPUERTOS INTERNACIONALES\" + Grupo +  "\\"+ Nivel + "\\" + Subnivel + "\\"+ Nombre+"";
