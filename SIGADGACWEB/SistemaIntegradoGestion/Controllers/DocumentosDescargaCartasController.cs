...
{
    public class DocumentosDescargaCartasController : Controller
    {
        /// <summary>
        /// cambio por github
        /// </summary>
        ...
        public ActionResult ListadoDocumentosDescargaCartas()
        {
            if (Session["Usuario"] == null)
                return RedirectToAction("login", "Login");
            ...
            listado = CD_DocumentosDescarga.Instancia.ConsultaDocumentosCartasAcuerdo();// SolicitudModificacionReprogramacionSoloPOA(cAnio, SesionUsuario.CodigoSubsistema, "MDP");
            return View(listado);
        }
        ...
        public ActionResult DescargaDcto( string Nombre)
        {
            ...
            string remoteUri = @"\\172.20.19.55\DocumentosDescarga\CartasdeAcuerdoOperacional\" + Nombre+"";
