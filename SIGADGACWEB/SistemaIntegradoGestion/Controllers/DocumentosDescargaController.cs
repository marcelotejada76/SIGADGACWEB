...
{
    public class DocumentosDescargaController : Controller
    {
        /// <summary>
        /// cambio por github
        /// </summary>
        ...
        public ActionResult ListadoDocumentosDescarga()
        {
            if (Session["Usuario"] == null)
                return RedirectToAction("login", "Login");
            ...
            listado = CD_DocumentosDescarga.Instancia.ConsultaDocumentos();// SolicitudModificacionReprogramacionSoloPOA(cAnio, SesionUsuario.CodigoSubsistema, "MDP");
            return View(listado);
        }
        ...
        public ActionResult DescargaDcto( string Nombre)
        {
            ...
            string remoteUri = @"\\172.20.19.55\DocumentosDescarga\" + Nombre+"";
