...
{
    public class DocumentosDescargaInstruccionesController : Controller
    {
        /// <summary>
        /// cambio por github
        /// </summary>
        ...
        public ActionResult ListadoDocumentosDescargaInstrucciones()
        {
            if (Session["Usuario"] == null)
                return RedirectToAction("login", "Login");
            ...
            listado = CD_DocumentosDescarga.Instancia.ConsultaDocumentosInstTecnicas();// SolicitudModificacionReprogramacionSoloPOA(cAnio, SesionUsuario.CodigoSubsistema, "MDP");
            return View(listado);
        }
        ...
        public ActionResult DescargaDcto( string Nombre)
        {
            ...
            string remoteUri = @"\\172.20.19.55\DocumentosDescarga\InstruccionesTecnicas\" + Nombre+"";
