...
{
    public class DocumentosDescargaFormulariosController : Controller
    {
        /// <summary>
        /// cambio por github
        /// </summary>
        ...
        public ActionResult ListadoDocumentosDescargaFormularios()
        {
            if (Session["Usuario"] == null)
                return RedirectToAction("login", "Login");
            ...
            listado = CD_DocumentosDescarga.Instancia.ConsultaDocumentosFormulariosAtm();// SolicitudModificacionReprogramacionSoloPOA(cAnio, SesionUsuario.CodigoSubsistema, "MDP");
            return View(listado);
        }
        ...
        public ActionResult DescargaDcto( string Nombre)
        {
            ...
            string remoteUri = @"\\172.20.19.55\DocumentosDescarga\FormulariosATM\" + Nombre+"";
