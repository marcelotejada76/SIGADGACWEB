...
{
    public class DocumentosSeguridadOperacionalController : Controller
    {
        /// <summary>
        /// cambio por github
        /// </summary>
        ...
        public ActionResult ListadoDocumentosSeguridadOperacional()
        {
            if (Session["Usuario"] == null)
                return RedirectToAction("login", "Login");
            ...
            listado = CD_DocumentosSeguridadOperacional.Instancia.ConsultaDocumentosSeguridadOperacional();// SolicitudModificacionReprogramacionSoloPOA(cAnio, SesionUsuario.CodigoSubsistema, "MDP");
            return View(listado);
        }
        ...
        public ActionResult DescargaDcto( string Nombre, string Cabecera)
        {
            ...
            string remoteUri = @"\\172.20.19.55\DocumentosDescarga\SEGURIDAD OPERACIONAL SMS\" + Cabecera +"\\" + Nombre+"";
