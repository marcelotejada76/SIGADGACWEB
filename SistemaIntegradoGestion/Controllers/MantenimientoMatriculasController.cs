...
{
    public class MantenimientoMatriculasController : Controller
    {
        /// <summary>
        /// cambio por github
        /// </summary>
        ...
        public ActionResult ListadoMatricula()
        {
            if (Session["Usuario"] == null)
                return RedirectToAction("login", "Login");
        ...
        [HttpPost]
        public ActionResult ListadoMatricula(string NombreCompania)
        {
